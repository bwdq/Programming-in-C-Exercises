...
{
    (void) value; // replace these lines with your code     AnyData ad;     ad.type = UNDEF;     return ad; }
...
{
    (void) first;  // replace these lines with your code     (void) last;     AnyData ad;     ad.type = UNDEF;     return ad; }
